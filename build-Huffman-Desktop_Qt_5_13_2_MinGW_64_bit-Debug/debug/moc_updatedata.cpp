/****************************************************************************
** Meta object code from reading C++ file 'updatedata.h'
**
...
#include <memory>
#include "../../Huffman/updatedata.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'updatedata.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 34, 23) // "on_pushButton_2_clicked"
    ...
    "UpdateData\0on_pushButton_clicked\0\0"
...
void UpdateData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<UpdateData *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject UpdateData::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_UpdateData.data,
    qt_meta_data_UpdateData,
    qt_static_metacall,
    nullptr,
    nullptr
} };
